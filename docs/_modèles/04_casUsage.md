...
*Ce chapitre définit la convention d'identifiant stable attribuée à chaque cas d'usage / user story (par exemple US-xxx), réutilisée sans renommage dans les étapes suivantes.*
...
*Ce chapitre vérifie que chaque objectif mesurable du projet (étape 2) est couvert par au moins un cas d'usage / user story.*

| objectif | cas d'usage / user story |
|---|---|
| | |
