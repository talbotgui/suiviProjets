...
| Mettre en place un script de journalisation automatique des prompts significatifs (traçabilité des échanges) | à définir (script + répertoire de logs) | [1](./01_modalitesUsageEtConventions.md#traçabilité-des-échanges-significatifs) | 12 (poste développeur) — écarté de l'étape 9, qui ne couvre que la structuration du code, le Git et la qualité, pas l'outillage de poste | différé |
