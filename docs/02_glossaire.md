...
| [Script de journalisation des prompts définitivement reporté à l'étape 17 (poste développeur)](./plan_01_miseEnPlace.md#actions-issues-de-létape-1--modalités-dusage-de-lia-et-glossaire) | Mise en place à l'étape 9 (normes de développement) | L'étape 9 couvre la structuration du code, le Git et la qualité, pas l'outillage de poste ; l'étape 17 est le point naturel pour cet outillage | 9 | 2026-07-18 |
