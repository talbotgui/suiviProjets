...
├── Commits des membres (régularité des poussées de code d'un groupe, tableau de tri nominatif, résultat en mémoire de session)
├── Liste de travail
...
- La sidebar (232px, cf. [maquette de référence](../01_besoin/Suivi%20Qualimetrie.dc.html)) reste visible en permanence dans le shell applicatif et matérialise l'écran actif ; elle donne accès direct, dans cet ordre fixe, à Administration, Audits, Synthèse des audits, Synthèse graphique, Obsolescence, Commits des membres, Liste de travail, Accueil et Paramétrage. Cet ordre (révisé le 2026-08-08, [C11-03](../03_plan/plan_13_developpement.md#phase-11--journalisation-technique-et-confort-de-saisie-projets-sources) ; « Commits des membres » inséré juste après Obsolescence, avant Liste de travail, avec [plan_17](../03_plan/plan_17_metriquesVolumetrie.md) chapitre 4) reflète la séquence d'usage typique d'un utilisateur — constituer son périmètre (Administration) puis l'auditer (Audits) avant de consulter des résultats encore vides à la création du fichier — plutôt que l'ordre initial retenu à la Phase 6 (Accueil en tête) ; il reste unique et fixe, indépendant du contenu du fichier ouvert (piste alternative d'un ordre dynamique selon la présence d'un audit intégré écartée par arbitrage humain explicite, pour ne pas introduire de réordonnancement surprenant en cours de session).
- L'écran « Commits des membres » ([US-060](./04_casUsage.md#cas-dusage--user-stories)) est accessible depuis la sidebar uniquement ; il ne s'ouvre depuis aucun lien contextuel et n'en émet qu'un seul, « Ajuster les seuils », vers l'onglet « Réglages applicatifs » du Paramétrage (écran de la sidebar, sans quatrième niveau de navigation).
...
- Sur la Fiche projet, la ligne d'un membre `interne` dont le statut est résolu contre une règle de type `username` ou `email` porte, à côté du lien « Qualifier ce membre » déjà existant, un lien « Marquer comme parti » ([US-061](./04_casUsage.md#cas-dusage--user-stories)) qui ouvre l'écran d'Administration (sous-onglet Membres connus du bon groupe) pré-filtré sur cette règle, le champ `partiLe` pré-rempli à la date du jour ; il réutilise le mécanisme de paramètres de requête de qualification déjà en place et pointe vers un écran de la sidebar, sans créer de quatrième niveau de navigation.
...
| Administration | [US-006](./04_casUsage.md#cas-dusage--user-stories), [US-007](./04_casUsage.md#cas-dusage--user-stories), [US-008](./04_casUsage.md#cas-dusage--user-stories), [US-023](./04_casUsage.md#cas-dusage--user-stories), [US-024](./04_casUsage.md#cas-dusage--user-stories), [US-055](./04_casUsage.md#cas-dusage--user-stories), [US-061](./04_casUsage.md#cas-dusage--user-stories), [US-064](./04_casUsage.md#cas-dusage--user-stories) |
| Constitution de campagne | [US-009](./04_casUsage.md#cas-dusage--user-stories), [US-012](./04_casUsage.md#cas-dusage--user-stories), [US-058](./04_casUsage.md#cas-dusage--user-stories) |
...
| Synthèse des audits | [US-015](./04_casUsage.md#cas-dusage--user-stories), [US-032](./04_casUsage.md#cas-dusage--user-stories), [US-053](./04_casUsage.md#cas-dusage--user-stories), [US-064](./04_casUsage.md#cas-dusage--user-stories) |
| Synthèse graphique | [US-016](./04_casUsage.md#cas-dusage--user-stories), [US-019](./04_casUsage.md#cas-dusage--user-stories), [US-032](./04_casUsage.md#cas-dusage--user-stories), [US-053](./04_casUsage.md#cas-dusage--user-stories), [US-062](./04_casUsage.md#cas-dusage--user-stories) |
| Obsolescence | [US-050](./04_casUsage.md#cas-dusage--user-stories), [US-051](./04_casUsage.md#cas-dusage--user-stories), [US-053](./04_casUsage.md#cas-dusage--user-stories), [US-057](./04_casUsage.md#cas-dusage--user-stories), [US-065](./04_casUsage.md#cas-dusage--user-stories) |
| Commits des membres | [US-060](./04_casUsage.md#cas-dusage--user-stories) |
| Fiche projet | [US-017](./04_casUsage.md#cas-dusage--user-stories), [US-022](./04_casUsage.md#cas-dusage--user-stories), [US-032](./04_casUsage.md#cas-dusage--user-stories), [US-056](./04_casUsage.md#cas-dusage--user-stories), [US-057](./04_casUsage.md#cas-dusage--user-stories), [US-058](./04_casUsage.md#cas-dusage--user-stories), [US-061](./04_casUsage.md#cas-dusage--user-stories), [US-062](./04_casUsage.md#cas-dusage--user-stories), [US-064](./04_casUsage.md#cas-dusage--user-stories) |
