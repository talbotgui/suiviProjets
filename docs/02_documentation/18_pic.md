...
| Tests unitaires et couverture | `cargo test` + `cargo-llvm-cov`, Jest + couverture Istanbul ; échec du pipeline si les seuils de [90 %/80 % par périmètre](./16_normesTests.md#stratégie-de-couverture-de-code) ne sont pas atteints |
