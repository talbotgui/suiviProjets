...
| RG-038 | L'écran de paramétrage indique explicitement, pour chaque famille de seuils/référentiels/réglages applicatifs modifiable, le moment où une modification prend effet — instantanément sur l'historique déjà affiché, seulement sur les audits collectés après la modification, ou seulement sur la prochaine campagne lancée — sans jamais laisser une modification silencieuse quant à sa portée réelle (ajouté le 2026-08-17, cf. [C15-05](../03_plan/plan_13_developpement.md#phase-15--recette-et-durcissement-avant-première-version-utilisable)) | Écran de paramétrage | Affichage de chaque section modifiable de l'écran de paramétrage |
...
| RG-038 | [US-040](./04_casUsage.md#cas-dusage--user-stories) |
