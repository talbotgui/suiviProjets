...
| Écran de paramétrage | Seuils, référentiels (et leur suppression), journal des modifications (et sa purge), purge des audits, export/import de configuration, réglages applicatifs, avertissement de taille du fichier | RG-003, RG-012, RG-022, RG-023, RG-024, RG-025, RG-028, RG-029, RG-030, RG-031, RG-032, RG-034, RG-035, RG-038 |
