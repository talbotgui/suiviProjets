...
| UI — Écrans et navigation | [Tests de bout en bout](#tests-de-bout-en-bout) (quatre séquences minimales) ; couverture par fonctions pour le reste des scénarios (cf. [Stratégie de couverture de code](#stratégie-de-couverture-de-code)) |
