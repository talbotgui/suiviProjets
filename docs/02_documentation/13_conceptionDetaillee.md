...
| Gestion des erreurs et cas limites (les 9 cas détaillés ci-dessus : écriture interrompue, dérivation de clé incompatible, délai réseau dépassé, réponse HTTP inattendue, dépôt GitLab vide, fichier verrouillé par un autre processus, horloge système incohérente, recherche avant fin d'indexation, annulation en vol) | [RG-018](./05_reglesGestion.md#audits-et-campagnes), [RG-021](./05_reglesGestion.md#audits-et-campagnes), [RNF-005](./07_exigencesNonFonctionnelles.md#performance) ; couverture exhaustive par les tests détaillée dans la [matrice de traçabilité de l'étape 11](./16_normesTests.md#matrice-de-traçabilité), non dupliquée ici |
