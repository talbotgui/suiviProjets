...
| RNF-015 | Une Content Security Policy stricte est appliquée (sans `eval`, sans aucune source externe, sans `script-src 'unsafe-inline'`) et aucune injection HTML dynamique n'est permise, pour limiter le risque de vol de credentials via une XSS. Dérogation ciblée actée le 2026-09-03 (arbitrage humain, cf. [normes de sécurité](./15_normesSecurite.md#contrôle-des-entrées-et-sorties) et [rapport, Étape 37](../04_rapports/rapportDeDeveloppement.md#étape-37--clôture-rétroactive-des-phases-13-14-et-15-abandon-de-lupdater-tauri-et-des-actions-h10)) : `style-src` conserve `'unsafe-inline'`, imposé par les styles inline d'Angular, le reste de la politique restant strict |
| RNF-016 | Les dépendances du projet sont verrouillées (fichier de lock) et auditées en intégration continue, quel que soit l'écosystème de dépendances confirmé à l'étape 6 (détail en [Analyse des dépendances vulnérables](./15_normesSecurite.md#analyse-des-dépendances-vulnérables), étape 10, et en [mise en place du pipeline](./18_pic.md#mise-en-place-du-pipeline), étape 12) |
...
| identifiant | exigence |
|---|---|
| RNF-019 | L'interface respecte les critères de conformité [WCAG 2.1](https://www.w3.org/TR/WCAG21/) niveau AA, ainsi que le [RGAA](https://accessibilite.numerique.gouv.fr/) (Référentiel général d'amélioration de l'accessibilité, version 4.1.2, publié par la DINUM, décliné des mêmes principes que WCAG pour le contexte français) : contrastes suffisants, navigation clavier complète, structure sémantique, alternatives textuelles, focus visible (RGAA ajouté en Phase 11, R11-09, cf. [plan de développement](../03_plan/plan_13_developpement.md#phase-11--journalisation-technique-et-confort-de-saisie-projets-sources)) |
...
| Aucune RNF | [Permettre le pilotage effectif de l'usage de l'IA par projet](./03_expressionBesoin.md#objectifs-mesurables-du-projet) — objectif intégralement fonctionnel, sans exigence non fonctionnelle dédiée ; couvert par [RG-014](./05_reglesGestion.md#constat-jugement-et-politique-ia) à [RG-016](./05_reglesGestion.md#constat-jugement-et-politique-ia), [RG-023](./05_reglesGestion.md#seuils-référentiels-et-historisation) et US-009, US-017, US-024 |
