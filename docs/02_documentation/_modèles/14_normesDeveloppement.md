...
4. [Gestion des dépendances et reproductibilité](#gestion-des-dépendances-et-reproductibilité)
5. [Règles de qualité de code](#règles-de-qualité-de-code)
   1. [Rigueur de typage et de documentation — <langage 1>](#rigueur-de-typage-et-de-documentation--langage-1)
   2. [Rigueur de typage et de documentation — <langage 2>](#rigueur-de-typage-et-de-documentation--langage-2)
...
### Rigueur de typage et de documentation — <langage 1>
...
### Rigueur de typage et de documentation — <langage 2>
