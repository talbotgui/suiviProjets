...
À ce stade du projet, l'historique des sessions et les commits Git constituent la trace de référence des échanges et décisions significatifs. La mise en place d'un script dédié de journalisation automatique des prompts, évoquée comme bonne pratique, est différée : elle sera étudiée aux étapes normes de développement (étape 9) et poste développeur (étape 17), une fois l'outillage de développement défini. Ce report est tracé dans le [plan de mise en place](./plan_01_miseEnPlace.md#actions-issues-de-létape-1--modalités-dusage-de-lia-et-glossaire).
