...
// route racine ; à revoir dès que l'écran d'accueil sera construit. Les deux écrans d'Audits (Phase 5, incrément
// 5) suivent le même choix pragmatique, routés seuls sans shell applicatif (aucun shell ne existe encore, cf.
