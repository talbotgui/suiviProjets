...
- Mesure : [cargo-llvm-cov](https://github.com/taiki-e/cargo-llvm-cov) (Rust, seuil global 80 %), couverture Istanbul intégrée à Jest (TypeScript). Les deux rapports HTML sont publiés sur GitHub Pages à chaque création de release (Phase 14), pas seulement en artefact de run.
