...
//! mémoire des credentials et test de connectivité (US-003, US-004). La Façade n'est jamais testée isolément :
//! chaque commande délègue au module qu'elle route (Moteur de persistance, Connecteur GitLab/Sonar), déjà couvert
//! par ses propres tests unitaires (cf. `docs/02_documentation/16_normesTests.md#tests-unitaires`).
